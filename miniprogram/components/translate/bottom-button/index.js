...
let buttonBackground = {
  zh_CN: {
    normal: '../../../images/button_zh.png',
    press: '../../../images/button_zh_press.png',
    disabled: '../../../images/button_zh_disabled.png'
  },
  en_US: {
    normal: '../../../images/button_en.png',
    press: '../../../images/button_en_press.png',
    disabled: '../../../images/button_en_disabled.png'
  }
};
...
Component({
  ...
  methods: {
    ...
    streamRecord(event) {
      ...
      let currentButtonConf = event.currentTarget.dataset.conf;
